    ...
    public void run() {
        ...
        if (!isFinisheed) {
            ...
            CommandScheduler.getInstance().schedule(new SequentialCommandGroup(
                    new GotoConstantHeading(3.2, 0),
                    new GotoConstantHeading(3, 51),
                    CommandGroups.TransferConeGroup(11, 47, -45, 1010),

                    new GotoLinearHeading(-5.2, 53, 0),
                    CommandGroups.CatchConeGroup(-254),
                    ...
                    new GotoLinearHeading(-4.9, 53, 0),
                    CommandGroups.CatchConeGroup(-283),
                    new SorinMakesBetterWaitCommands(400),
                    CommandGroups.DepositGroup(),
                    new GotoConstantHeading(3, 51),
                    CommandGroups.TransferConeGroup(11, 47, -45, 1010),
        ...
        SwerveDriveKinematics mamaie = new SwerveDriveKinematics();
